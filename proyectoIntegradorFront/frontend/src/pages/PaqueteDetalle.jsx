        ...
        {ultimoHistorial && (
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              ...
              <p>
                <b>Editor:</b> {ultimoHistorial.editor}
              </p>
              <p>
                    ...
                    {ultimoHistorial.cambios.map((cambio, index) => (
                      <li key={index} style={{ marginBottom: "8px" }}>
                        {cambio.campo &&
                          ...
                          cambio.despues !== undefined && (
                            <>
                              <b>Campo:</b> {cambio.campo}
                              <br />
                              <b>Antes:</b> {String(cambio.antes)}
                              <br />
                              <b>Después:</b> {String(cambio.despues)}
                            </>
                          )}
                        ...
                        {cambio.campo === "estado" &&
                          ...
                          cambio.valorNuevo && (
                            <>
                              <b>Estado anterior:</b> {cambio.valorAnterior}
                              <br />
          ...
          historialSinUltimo.map((h) => (
            <div key={h.id} className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <p>
                  <b>Fecha:</b> {new Date(h.fecha).toLocaleString()}
                </p>
